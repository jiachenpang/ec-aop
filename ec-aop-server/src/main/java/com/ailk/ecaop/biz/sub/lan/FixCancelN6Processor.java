...
@EcRocTag("fixcancelN6")
public class FixCancelN6Processor extends BaseAopProcessor {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        BigExt.put("tradeOther", preTradeOther(msg));
        msg.put("ext", BigExt);

        Exchange exchange3 = ExchangeUtils.ofCopy(exchange2, msg);

        lan.preData("ecaop.trades.mofc.N6.cancelPre.paramtersmapping", exchange3);
        CallEngine
                .wsCall(exchange3, "ecaop.comm.conf.url.n6ess.services.AOPOrdForNorthSer" + "." + msg.get("province"));
        lan.xml2Json("ecaop.trades.sccc.cancelPre.template", exchange3);
        ...
        // 正式提交
        lan.preData("ecaop.trades.fasb.N6.ParametersMapping", exchange4cBOrderSub);
        CallEngine.wsCall(exchange4cBOrderSub,
                "ecaop.comm.conf.url.n6ess.services.AOPOrdForNorthSer" + "." + msg.get("province"));
        lan.xml2Json("ecaop.trades.fasb.template", exchange4cBOrderSub);
