...
public class ActivityInfoProcessor {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        Map msgcontainer = new HashMap();// 备份信息
        ...
        // 生成cb订单号
        String orderid = GetSeqUtil.getSeqFromCb(exchange, "seq_trade_id");
        ...
        // phoneTemplate信息
        List<Map> activityInfo = (List) ((Map) msg.get("newUserInfo")).get("activityInfo");
        ...
        // 产品信息
        String productId = (String) ((Map) ((Map) msg.get("newUserInfo")).get("productInfo")).get("productId");
        ...
        if (activityInfo != null && activityInfo.size() > 0) {
            for (int i = 0; i < activityInfo.size(); i++) {
                ...
                actparam.put("FIRST_MON_BILL_MODE", firstMonBillMode);
     ...
     * @return
     */
    private void preExtDataforItem(Map msg) {
        msg.put("tradeProductType", preProductTpyeListData(msg));// productTypeList
        msg.put("tradeProduct", preProductData(msg));// productList
        msg.put("tradeDiscnt", preDiscntData(msg));// discntList
        msg.put("tradeSvc", preTradeSvcData(msg));// svcList
        msg.put("tradeSp", preTradeSpData(msg));// spList
        // msg.put("tradePurchase", preTradePurchase(msg));// tradePurchase 放进去了
        // msg.put("tradeItem", preTradeItem(msg));// itemList 放进去了
        msg.put("tradefeeSub", preTradeFeeSub(msg));// tradeFeeItemList
        if ("1".equals(getPayModeCode(msg)) || "3".equals(getPayModeCode(msg)))
        {
            msg.put("tradeAcctConsign", preTradeAcctConsign(msg));
        }
    }
