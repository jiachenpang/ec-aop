...
public class YearForHN {

    protected ParametersMappingProcessor[] pmp = null;

    public YearForHN(ParametersMappingProcessor[] pmp) {
        this.pmp = pmp;
    }
    ...
    private Map preDataForTradeSubItem(Map msg, Boolean flag) {
        ...
        if (flag) {
            ...
            Item.add(lan.createTradeSubItem("SPEED",
                    "".equals(msg.get("speedLevel")) ? "110008" : msg.get("speedLevel"),
                    itemId));
            ...
            Item.add(lan.createTradeSubItemC(itemId, "fixedHire", msg.get("fixedHire"),
                    startDate, endDate));
            ...
            Item.add(lan.createTradeSubItemB2(userId, "TIME_SHARING", "0"));
            Item.add(lan.createTradeSubItemB2(userId, "REMARK", "S30"));
            Item.add(lan.createTradeSubItemB2(userId, "BILLINGRATE", "110008"));
            Item.add(lan.createTradeSubItemB2(userId, "LINK_NAME", msg.get("customerName")));
            Item.add(lan.createTradeSubItemB2(userId, "CONTACT_CONFIRM", "1"));
            Item.add(lan.createTradeSubItemB2(userId, "SPEED",
                    "".equals(msg.get("speedLevel")) ? "110008" : msg.get("speedLevel")));
            Item.add(lan.createTradeSubItemB2(userId, "LINK_PHONE", msg.get("contactPerson")));
            Item.add(lan.createTradeSubItemB2(userId, "BOOKTIME", ""));
        }
