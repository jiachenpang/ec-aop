 ...
 */
@EcRocTag("N6openBroadBandPreCommit")
public class N6OpenBroadBandPreCommitProcessor extends BaseAopProcessor {
    ...
    public Map dealParams(Exchange exchange) throws Exception {
        ...
        itemUser.put("developEparchyCode", ChangeCodeUtils.changeEparchy(msg));
        ...
        tradeSubItem.add(lan.createTradeSubItem("SEL_LOCAL_NET_ID", ChangeCodeUtils.changeEparchy(msg), itemId));
    ...
    public Map dealPro(Exchange exchange) {
        ...
        Map ext = TradeManagerUtils.preProductInfo(productInfo, provinceCode,
                msg);
