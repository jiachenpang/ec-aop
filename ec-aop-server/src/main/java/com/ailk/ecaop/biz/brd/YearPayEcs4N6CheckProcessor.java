...
import com.ailk.ecaop.biz.sub.lan.YearPayEcs4N6Check;
...
@EcRocTag("yearPayEcs4N6Check")
public class YearPayEcs4N6CheckProcessor extends BaseAopProcessor implements ParamsAppliable {
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        //通过relationTypeCode判断是不是融合号码(三户的时候判断会存一个)
        if (!IsEmptyUtils.isEmpty(msg.get("relationTypeCode"))) {
            ...
            YearPayEcs4N6Check check = new YearPayEcs4N6Check(pmp);
