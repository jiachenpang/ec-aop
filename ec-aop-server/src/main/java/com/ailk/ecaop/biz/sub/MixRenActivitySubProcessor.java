...
@EcRocTag("mixRenActivitySub")
public class MixRenActivitySubProcessor extends BaseAopProcessor implements ParamsAppliable {

    private static final String[] PARAM_ARRAY = { "ecaop.masb.odsb.ActivityAryParametersMapping" };
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        String provOrderId = String.valueOf(msg.get("essSubscribeId"));
        ...
        for (Map feeMap : feeInfoList) {
            ...
            feeMap.put("origFee", Integer.valueOf((String) feeMap.get("origFee")) / 10 + "");
            feeMap.put("reliefFee", Integer.valueOf((String) feeMap.get("reliefFee")) / 10 + "");
            feeMap.put("realFee", Integer.valueOf((String) feeMap.get("realFee")) / 10 + "");
